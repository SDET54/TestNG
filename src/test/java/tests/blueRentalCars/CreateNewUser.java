...
public class CreateNewUser {
    ...
    public void test01() {
        ...
        bluerentalcarsPage.ilkLoginElement.click();
        ...
        wait.until(ExpectedConditions.elementToBeClickable(bluerentalcarsPage.registerButtonElement));
        ...
        bluerentalcarsPage.emailKutusuElement.sendKeys(emailAddress);
        bluerentalcarsPage.passwordKutusuElement.sendKeys(password);
        bluerentalcarsPage.ikinciLoginElement.click();

        // 8-Doğru şekilde siteye giriş yaptığınızı test ediniz.
        String actualName = bluerentalcarsPage.profilIsmiElement.getText();
